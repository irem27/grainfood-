    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-900 mt-1">Footer’daki e-posta abonelik listesini buradan yönetin.</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {loading ? (
          <div className="p-10 text-center text-gray-900">Yükleniyor...</div>
        ) : filtered.length === 0 ? (
          <div className="p-10 text-center text-gray-900">Kayıt bulunamadı.</div>
        ) : (
              ...
              <tbody className="divide-y divide-gray-100">
                {filtered.map((s) => (
                  <tr key={s.id} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-5 py-4 text-gray-900">{formatDate(s.createdAt)}</td>
                    <td className="px-5 py-4">
